        ...
        <?php if ($query->have_posts()) : ?>
            ...
            <div class="blog__list__new">
                ...
                <div class="blog__list__new__info">
                    ...
                    <div class="blog__list__info__new__middle">
                        ...
                        <div class="blog__list__info__new__category__wrap">
                            ...
                            ?>
                                <a href="<?php echo get_category_link($cat->term_id); ?>" class="blog__list__info__new__category" style="background-color: <?php echo esc_attr($category_color); ?>;"><?php echo $cat->name; ?></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    <div class="blog__list__info__new__bottom">
                        <a class="blog__list__info__new__bottom__avatar" href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>">
                            <?php echo get_avatar(get_the_author_meta('ID'), 40); ?>
                        </a>
                        <a class="blog__list___info__new__bottom__name" href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>">
                            <?php the_author(); ?>
                        </a>
                    </div>
                </div>
