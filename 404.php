...
<head prefix="og: http://ogp.me/ns# website: http://ogp.me/ns/website#">
    ...
    <link rel="stylesheet" href="<?php echo $uri; ?>/assets/css/loading.css" />
...
<body data-barba="wrapper">
    ...
    <div class="header__nav">
        <div id="header__nav__button">
            <span class="nav__line">\</span>&nbsp;<span id="header__nav__button__text">MENU</span>&nbsp;<span
                class="nav__line">\</span>
        </div>
    </div>
    ...
    <div class="nav">
        <div class="nav__overlay">
            <svg viewBox="0 0 1000 1000">
                <path d="M0 2S175 1 500 1s500 1 500 1V0VH0Z"></path>
            </svg>
